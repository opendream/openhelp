	...
	<table class="bordered-table">
	  ...
	  <tbody>
	    ...
	    <tr>
	      ...
	      <td><input class="span2"  name="Data[773]" type="text" value="<?php echo $Data[773]; ?>"></td>
	      <td><input class="span2"  name="Data[774]" type="text" value="<?php echo $Data[774]; ?>"></td>
	    ...
	    <tr>
	      <td>- อื่น ๆ (โปรดระบุ) <input class="span2"  name="Data[777]" type="text" value="<?php echo $Data[777]; ?>"></td>
	      <td><input class="span2"  name="Data[778]" type="text" value="<?php echo $Data[778]; ?>"></td>
	      <td><input class="span2"  name="Data[779]" type="text" value="<?php echo $Data[779]; ?>"></td>
	      <td><input class="span2"  name="Data[780]" type="text" value="<?php echo $Data[780]; ?>"></td>
	      <td><input class="span2"  name="Data[781]" type="text" value="<?php echo $Data[781]; ?>"></td>
	      <td><input class="span2"  name="Data[782]" type="text" value="<?php echo $Data[782]; ?>"></td>
	    ...
	    <tr>
	      <td>- ศาลาประชาคม</td>
	      <td><input class="span2"  name="Data[785]" type="text" value="<?php echo $Data[785]; ?>"></td>
	      <td><input class="span2"  name="Data[786]" type="text" value="<?php echo $Data[786]; ?>"></td>
	      <td><input class="span2"  name="Data[787]" type="text" value="<?php echo $Data[787]; ?>"></td>
	      <td><input class="span2"  name="Data[788]" type="text" value="<?php echo $Data[788]; ?>"></td>
	      <td><input class="span2"  name="Data[789]" type="text" value="<?php echo $Data[789]; ?>"></td>
	    ...
	    <tr>
	      ...
	      <td><input class="span2"  name="Data[792]" type="text" value="<?php echo $Data[792]; ?>"></td>
	      <td><input class="span2"  name="Data[793]" type="text" value="<?php echo $Data[793]; ?>"></td>
	      <td><input class="span2"  name="Data[794]" type="text" value="<?php echo $Data[794]; ?>"></td>
	      <td><input class="span2"  name="Data[795]" type="text" value="<?php echo $Data[795]; ?>"></td>
	      <td><input class="span2"  name="Data[796]" type="text" value="<?php echo $Data[796]; ?>"></td>
	    ...
	    <tr>
	      <td>- ลานกีฬา</td>
	      <td><input class="span2"  name="Data[799]" type="text" value="<?php echo $Data[799]; ?>"></td>
	      <td><input class="span2"  name="Data[800]" type="text" value="<?php echo $Data[801]; ?>"></td>
	      <td><input class="span2"  name="Data[802]" type="text" value="<?php echo $Data[802]; ?>"></td>
	      <td><input class="span2"  name="Data[803]" type="text" value="<?php echo $Data[803]; ?>"></td>
	      <td><input class="span2"  name="Data[804]" type="text" value="<?php echo $Data[804]; ?>"></td>
	    ...
	    <tr>
	      <td>- อื่น ๆ(โปรดระบุ) <input class="span2"  name="Data[807]" type="text" value="<?php echo $Data[807]; ?>"></td>
	      <td><input class="span2"  name="Data[808]" type="text" value="<?php echo $Data[808]; ?>"></td>
	      <td><input class="span2"  name="Data[809]" type="text" value="<?php echo $Data[809]; ?>"></td>
	      <td><input class="span2"  name="Data[810]" type="text" value="<?php echo $Data[810]; ?>"></td>
	      <td><input class="span2"  name="Data[811]" type="text" value="<?php echo $Data[811]; ?>"></td>
	      <td><input class="span2"  name="Data[812]" type="text" value="<?php echo $Data[812]; ?>"></td>
	    ...
	    <tr>
	      <td>- วัด</td>
	      <td><input class="span2"  name="Data[815]" type="text" value="<?php echo $Data[815]; ?>"></td>
	      <td><input class="span2"  name="Data[816]" type="text" value="<?php echo $Data[816]; ?>"></td>
	      <td><input class="span2"  name="Data[817]" type="text" value="<?php echo $Data[817]; ?>"></td>
	      <td><input class="span2"  name="Data[818]" type="text" value="<?php echo $Data[818]; ?>"></td>
	      <td><input class="span2"  name="Data[819]" type="text" value="<?php echo $Data[819]; ?>"></td>
	    ...
	    <tr>
	      <td>- มัสยิด</td>
	      <td><input class="span2"  name="Data[822]" type="text" value="<?php echo $Data[822]; ?>"></td>
	      <td><input class="span2"  name="Data[823]" type="text" value="<?php echo $Data[823]; ?>"></td>
	      <td><input class="span2"  name="Data[824]" type="text" value="<?php echo $Data[824]; ?>"></td>
	      <td><input class="span2"  name="Data[825]" type="text" value="<?php echo $Data[825]; ?>"></td>
	      <td><input class="span2"  name="Data[826]" type="text" value="<?php echo $Data[826]; ?>"></td>
	    ...
	    <tr>
	      <td>- โบสถ์คริสต์</td>
	      <td><input class="span2"  name="Data[829]" type="text" value="<?php echo $Data[829]; ?>"></td>
	      <td><input class="span2"  name="Data[830]" type="text" value="<?php echo $Data[830]; ?>"></td>
	      <td><input class="span2"  name="Data[831]" type="text" value="<?php echo $Data[831]; ?>"></td>
	      <td><input class="span2"  name="Data[832]" type="text" value="<?php echo $Data[832]; ?>"></td>
	      <td><input class="span2"  name="Data[833]" type="text" value="<?php echo $Data[833]; ?>"></td>
	    ...
	    <tr>
	      <td>- โบราณสถาน</td>
	      <td><input class="span2"  name="Data[837]" type="text" value="<?php echo $Data[837]; ?>"></td>
	      <td><input class="span2"  name="Data[838]" type="text" value="<?php echo $Data[838]; ?>"></td>
	      <td><input class="span2"  name="Data[839]" type="text" value="<?php echo $Data[839]; ?>"></td>
	      <td><input class="span2"  name="Data[840]" type="text" value="<?php echo $Data[840]; ?>"></td>
	      <td><input class="span2"  name="Data[841]" type="text" value="<?php echo $Data[841]; ?>"></td>
	    ...
	    <tr>
	      <td>- อื่น ๆ(โปรดระบุ) <input class="span2"  name="Data[844]" type="text" value="<?php echo $Data[844]; ?>"></td>
	      <td><input class="span2"  name="Data[845]" type="text" value="<?php echo $Data[845]; ?>"></td>
	      <td><input class="span2"  name="Data[846]" type="text" value="<?php echo $Data[846]; ?>"></td>
	      <td><input class="span2"  name="Data[847]" type="text" value="<?php echo $Data[847]; ?>"></td>
	      <td><input class="span2"  name="Data[848]" type="text" value="<?php echo $Data[848]; ?>"></td>
	      <td><input class="span2"  name="Data[849]" type="text" value="<?php echo $Data[849]; ?>"></td>
	    ...
	    <tr>
	      <td>- สำนักงานอปท.</td>
	      <td><input class="span2"  name="Data[852]" type="text" value="<?php echo $Data[852]; ?>"></td>
	      <td><input class="span2"  name="Data[853]" type="text" value="<?php echo $Data[853]; ?>"></td>
	      <td><input class="span2"  name="Data[854]" type="text" value="<?php echo $Data[854]; ?>"></td>
	      <td><input class="span2"  name="Data[855]" type="text" value="<?php echo $Data[855]; ?>"></td>
	      <td><input class="span2"  name="Data[856]" type="text" value="<?php echo $Data[856]; ?>"></td>
	    ...
	    <tr>
	      ...
	      <td><input class="span2"  name="Data[859]" type="text" value="<?php echo $Data[859]; ?>"></td>
	      <td><input class="span2"  name="Data[860]" type="text" value="<?php echo $Data[860]; ?>"></td>
	      <td><input class="span2"  name="Data[861]" type="text" value="<?php echo $Data[861]; ?>"></td>
	      <td><input class="span2"  name="Data[862]" type="text" value="<?php echo $Data[862]; ?>"></td>
	      <td><input class="span2"  name="Data[863]" type="text" value="<?php echo $Data[863]; ?>"></td>
	    ...
	    <tr>
	      <td>- สถานีตำรวจ</td>
	      <td><input class="span2"  name="Data[866]" type="text" value="<?php echo $Data[866]; ?>"></td>
	      <td><input class="span2"  name="Data[867]" type="text" value="<?php echo $Data[867]; ?>"></td>
	      <td><input class="span2"  name="Data[868]" type="text" value="<?php echo $Data[868]; ?>"></td>
	      <td><input class="span2"  name="Data[869]" type="text" value="<?php echo $Data[869]; ?>"></td>
	      <td><input class="span2"  name="Data[870]" type="text" value="<?php echo $Data[870]; ?>"></td>
	    ...
	    <tr>
	      <td>- รพ.สต.</td>
	      <td><input class="span2"  name="Data[873]" type="text" value="<?php echo $Data[873]; ?>"></td>
	      <td><input class="span2"  name="Data[874]" type="text" value="<?php echo $Data[874]; ?>"></td>
	      <td><input class="span2"  name="Data[875]" type="text" value="<?php echo $Data[875]; ?>"></td>
	      <td><input class="span2"  name="Data[876]" type="text" value="<?php echo $Data[876]; ?>"></td>
	      <td><input class="span2"  name="Data[877]" type="text" value="<?php echo $Data[877]; ?>"></td>
	    ...
	    <tr>
	      <td>- โรงพยาบาล</td>
	      <td><input class="span2"  name="Data[880]" type="text" value="<?php echo $Data[880]; ?>"></td>
	      <td><input class="span2"  name="Data[881]" type="text" value="<?php echo $Data[881]; ?>"></td>
	      <td><input class="span2"  name="Data[882]" type="text" value="<?php echo $Data[882]; ?>"></td>
	      <td><input class="span2"  name="Data[883]" type="text" value="<?php echo $Data[883]; ?>"></td>
	      <td><input class="span2"  name="Data[884]" type="text" value="<?php echo $Data[884]; ?>"></td>
	    ...
	    <tr>
	      <td>- โรงเรียน</td>
	      <td><input class="span2"  name="Data[887]" type="text" value="<?php echo $Data[887]; ?>"></td>
	      <td><input class="span2"  name="Data[888]" type="text" value="<?php echo $Data[888]; ?>"></td>
	      <td><input class="span2"  name="Data[889]" type="text" value="<?php echo $Data[889]; ?>"></td>
	      <td><input class="span2"  name="Data[890]" type="text" value="<?php echo $Data[890]; ?>"></td>
	      <td><input class="span2"  name="Data[891]" type="text" value="<?php echo $Data[891]; ?>"></td>
	    ...
	    <tr>
	      ...
	      <td><input class="span2"  name="Data[894]" type="text" value="<?php echo $Data[894]; ?>"></td>
	      <td><input class="span2"  name="Data[895]" type="text" value="<?php echo $Data[895]; ?>"></td>
	      <td><input class="span2"  name="Data[896]" type="text" value="<?php echo $Data[896]; ?>"></td>
	      <td><input class="span2"  name="Data[897]" type="text" value="<?php echo $Data[897]; ?>"></td>
	      <td><input class="span2"  name="Data[898]" type="text" value="<?php echo $Data[898]; ?>"></td>
	    ...
	    <tr>
	      <td>- อื่น ๆ (โปรดระบุ) <input class="span2"  name="Data[902]" type="text" value="<?php echo $Data[902]; ?>"></td>
	      <td><input class="span2"  name="Data[903]" type="text" value="<?php echo $Data[903]; ?>"></td>
	      <td><input class="span2"  name="Data[904]" type="text" value="<?php echo $Data[904]; ?>"></td>
	      <td><input class="span2"  name="Data[905]" type="text" value="<?php echo $Data[905]; ?>"></td>
	      <td><input class="span2"  name="Data[906]" type="text" value="<?php echo $Data[906]; ?>"></td>
	      <td><input class="span2"  name="Data[907]" type="text" value="<?php echo $Data[907]; ?>"></td>
	    ...
	    <tr>
	      <td>- ระบุ <input class="span2"  name="Data[910]" type="text" value="<?php echo $Data[910]; ?>"></td>
	      <td><input class="span2"  name="Data[911]" type="text" value="<?php echo $Data[911]; ?>"></td>
	      <td><input class="span2"  name="Data[912]" type="text" value="<?php echo $Data[912]; ?>"></td>
	      <td><input class="span2"  name="Data[913]" type="text" value="<?php echo $Data[913]; ?>"></td>
	      <td><input class="span2"  name="Data[914]" type="text" value="<?php echo $Data[914]; ?>"></td>
	      <td><input class="span2"  name="Data[915]" type="text" value="<?php echo $Data[915]; ?>"></td>
	    ...
	    <tr>
	      <td>- ระบุ <input class="span2"  name="Data[918]" type="text" value="<?php echo $Data[918]; ?>"></td>
	      <td><input class="span2"  name="Data[919]" type="text" value="<?php echo $Data[919]; ?>"></td>
	      <td><input class="span2"  name="Data[920]" type="text" value="<?php echo $Data[920]; ?>"></td>
	      <td><input class="span2"  name="Data[921]" type="text" value="<?php echo $Data[921]; ?>"></td>
	      <td><input class="span2"  name="Data[922]" type="text" value="<?php echo $Data[922]; ?>"></td>
	      <td><input class="span2"  name="Data[923]" type="text" value="<?php echo $Data[923]; ?>"></td>
	    ...
	    <tr>
	      <td>- ระบบประปา</td>
	      <td><input class="span2"  name="Data[925]" type="text" value="<?php echo $Data[925]; ?>"></td>
	      <td><input class="span2"  name="Data[926]" type="text" value="<?php echo $Data[926]; ?>"></td>
	      <td><input class="span2"  name="Data[927]" type="text" value="<?php echo $Data[927]; ?>"></td>
	      <td><input class="span2"  name="Data[928]" type="text" value="<?php echo $Data[928]; ?>"></td>
	      <td><input class="span2"  name="Data[929]" type="text" value="<?php echo $Data[929]; ?>"></td>
	      <td><input class="span2"  name="Data[930]" type="text" value="<?php echo $Data[930]; ?>"></td>
	      <td><input class="span4"  name="Data[931]" type="text" value="<?php echo $Data[931]; ?>"></td>
	    </tr>
	    <tr>
	      <td>- บ่อน้ำตื้น</td>
	      <td><input class="span2"  name="Data[932]" type="text" value="<?php echo $Data[932]; ?>"></td>
	      <td><input class="span2"  name="Data[933]" type="text" value="<?php echo $Data[933]; ?>"></td>
	      <td><input class="span2"  name="Data[934]" type="text" value="<?php echo $Data[934]; ?>"></td>
	      <td><input class="span2"  name="Data[935]" type="text" value="<?php echo $Data[935]; ?>"></td>
	      <td><input class="span2"  name="Data[936]" type="text" value="<?php echo $Data[936]; ?>"></td>
	    ...
	    <tr>
	      <td>- บ่อบาดาล</td>
	      <td><input class="span2"  name="Data[939]" type="text" value="<?php echo $Data[939]; ?>"></td>
	      <td><input class="span2"  name="Data[940]" type="text" value="<?php echo $Data[940]; ?>"></td>
	      <td><input class="span2"  name="Data[941]" type="text" value="<?php echo $Data[941]; ?>"></td>
	      <td><input class="span2"  name="Data[942]" type="text" value="<?php echo $Data[942]; ?>"></td>
	      <td><input class="span2"  name="Data[943]" type="text" value="<?php echo $Data[943]; ?>"></td>
	    ...
	    <tr>
	      <td>- เขื่อน/ฝ้าย</td>
	      <td><input class="span2"  name="Data[946]" type="text" value="<?php echo $Data[946]; ?>"></td>
	      <td><input class="span2"  name="Data[947]" type="text" value="<?php echo $Data[947]; ?>"></td>
	      <td><input class="span2"  name="Data[948]" type="text" value="<?php echo $Data[948]; ?>"></td>
	      <td><input class="span2"  name="Data[949]" type="text" value="<?php echo $Data[949]; ?>"></td>
	      <td><input class="span2"  name="Data[950]" type="text" value="<?php echo $Data[950]; ?>"></td>
	    ...
	    <tr>
	      ...
	      <td><input class="span2"  name="Data[953]" type="text" value="<?php echo $Data[953]; ?>"></td>
	      <td><input class="span2"  name="Data[954]" type="text" value="<?php echo $Data[954]; ?>"></td>
	      <td><input class="span2"  name="Data[955]" type="text" value="<?php echo $Data[955]; ?>"></td>
	      <td><input class="span2"  name="Data[956]" type="text" value="<?php echo $Data[956]; ?>"></td>
	      <td><input class="span2"  name="Data[957]" type="text" value="<?php echo $Data[957]; ?>"></td>
	    ...
	    <tr>
	      <td>- อื่น ๆ <input class="span2"  name="Data[960]" type="text" value="<?php echo $Data[960]; ?>"></td>
	      <td><input class="span2"  name="Data[961]" type="text" value="<?php echo $Data[961]; ?>"></td>
	      <td><input class="span2"  name="Data[962]" type="text" value="<?php echo $Data[962]; ?>"></td>
	      <td><input class="span2"  name="Data[963]" type="text" value="<?php echo $Data[963]; ?>"></td>
	      <td><input class="span2"  name="Data[964]" type="text" value="<?php echo $Data[964]; ?>"></td>
	      <td><input class="span2"  name="Data[965]" type="text" value="<?php echo $Data[965]; ?>"></td>
	    ...
	    <tr>
	      <td>- มลพิษอื่น ๆ ระบุ <input class="span2"  name="Data[982]" type="text" value="<?php echo $Data[982]; ?>"></td>
	    ...
	    <tr>
	      <td colspan="8" class="table-lv2"><h4>3.4.1 พื้นที่การเกษตรเสียหาย (ระบุจำนวนไร่)</h4></td>
	    </tr>
	    <tr>
	      <td>- นาข้าว</td>
	      <td><input class="span2"  name="Data[54]" type="text" value="<?php echo $Data[54]; ?>"></td>
	      <td><input class="span2"  name="Data[55]" type="text" value="<?php echo $Data[55]; ?>"></td>
	      <td><input class="span2"  name="Data[56]" type="text" value="<?php echo $Data[56]; ?>"></td>
	      <td><input class="span2"  name="Data[57]" type="text" value="<?php echo $Data[57]; ?>"></td>
	      <td><input class="span2"  name="Data[58]" type="text" value="<?php echo $Data[58]; ?>"></td>
	    ...
	    <tr>
	      <td>- พืชสวน</td>
	      <td><input class="span2"  name="Data[85]" type="text" value="<?php echo $Data[85]; ?>"></td>
	      <td><input class="span2"  name="Data[86]" type="text" value="<?php echo $Data[86]; ?>"></td>
	      <td><input class="span2"  name="Data[87]" type="text" value="<?php echo $Data[87]; ?>"></td>
	      <td><input class="span2"  name="Data[88]" type="text" value="<?php echo $Data[88]; ?>"></td>
	      <td><input class="span2"  name="Data[89]" type="text" value="<?php echo $Data[89]; ?>"></td>
	    ...
	    <tr>
	      <td>-พืชไร่</td>
	      <td><input class="span2"  name="Data[92]" type="text" value="<?php echo $Data[92]; ?>"></td>
	      <td><input class="span2"  name="Data[93]" type="text" value="<?php echo $Data[93]; ?>"></td>
	      <td><input class="span2"  name="Data[94]" type="text" value="<?php echo $Data[94]; ?>"></td>
	      <td><input class="span2"  name="Data[95]" type="text" value="<?php echo $Data[95]; ?>"></td>
	      <td><input class="span2"  name="Data[96]" type="text" value="<?php echo $Data[96]; ?>"></td>
	    ...
	    <tr>
	      <td>- อื่น ๆ <input class="span2"  name="Data[99]" type="text" value="<?php echo $Data[99]; ?>"></td>
	      <td><input class="span2"  name="Data[100]" type="text" value="<?php echo $Data[100]; ?>"></td>
	      <td><input class="span2"  name="Data[101]" type="text" value="<?php echo $Data[101]; ?>"></td>
	      <td><input class="span2"  name="Data[102]" type="text" value="<?php echo $Data[102]; ?>"></td>
	      <td><input class="span2"  name="Data[103]" type="text" value="<?php echo $Data[103]; ?>"></td>
	      <td><input class="span2"  name="Data[104]" type="text" value="<?php echo $Data[104]; ?>"></td>
	    ...
	    <tr>
	      <td>- ระบุ <input class="span2"  name="Data[107]" type="text" value="<?php echo $Data[107]; ?>"></td>
	      <td><input class="span2"  name="Data[108]" type="text" value="<?php echo $Data[108]; ?>"></td>
	      <td><input class="span2"  name="Data[109]" type="text" value="<?php echo $Data[109]; ?>"></td>
	      <td><input class="span2"  name="Data[110]" type="text" value="<?php echo $Data[110]; ?>"></td>
	      <td><input class="span2"  name="Data[111]" type="text" value="<?php echo $Data[111]; ?>"></td>
	      <td><input class="span2"  name="Data[112]" type="text" value="<?php echo $Data[112]; ?>"></td>
      ...
      <tr>
	      <td>- หมู</td>
	      <td><input class="span2"  name="Data[115]" type="text" value="<?php echo $Data[115]; ?>"></td>
	      <td><input class="span2"  name="Data[116]" type="text" value="<?php echo $Data[116]; ?>"></td>
	      <td><input class="span2"  name="Data[117]" type="text" value="<?php echo $Data[117]; ?>"></td>
	      <td><input class="span2"  name="Data[118]" type="text" value="<?php echo $Data[118]; ?>"></td>
	      <td><input class="span2"  name="Data[119]" type="text" value="<?php echo $Data[119]; ?>"></td>
      ...
      <tr>
	      <td>- วัว/ควาย</td>
	      <td><input class="span2"  name="Data[122]" type="text" value="<?php echo $Data[122]; ?>"></td>
	      <td><input class="span2"  name="Data[123]" type="text" value="<?php echo $Data[123]; ?>"></td>
	      <td><input class="span2"  name="Data[124]" type="text" value="<?php echo $Data[124]; ?>"></td>
	      <td><input class="span2"  name="Data[125]" type="text" value="<?php echo $Data[125]; ?>"></td>
	      <td><input class="span2"  name="Data[126]" type="text" value="<?php echo $Data[126]; ?>"></td>
      ...
      <tr>
	      <td>- เป็ด</td>
	      <td><input class="span2"  name="Data[129]" type="text" value="<?php echo $Data[129]; ?>"></td>
	      <td><input class="span2"  name="Data[130]" type="text" value="<?php echo $Data[130]; ?>"></td>
	      <td><input class="span2"  name="Data[131]" type="text" value="<?php echo $Data[131]; ?>"></td>
	      <td><input class="span2"  name="Data[132]" type="text" value="<?php echo $Data[132]; ?>"></td>
	      <td><input class="span2"  name="Data[133]" type="text" value="<?php echo $Data[133]; ?>"></td>
      ...
      <tr>
	      <td>- ไก่</td>
	      <td><input class="span2"  name="Data[136]" type="text" value="<?php echo $Data[136]; ?>"></td>
	      <td><input class="span2"  name="Data[137]" type="text" value="<?php echo $Data[137]; ?>"></td>
	      <td><input class="span2"  name="Data[138]" type="text" value="<?php echo $Data[138]; ?>"></td>
	      <td><input class="span2"  name="Data[139]" type="text" value="<?php echo $Data[139]; ?>"></td>
	      <td><input class="span2"  name="Data[140]" type="text" value="<?php echo $Data[140]; ?>"></td>
      ...
      <tr>
	      <td>- แพะ</td>
	      <td><input class="span2"  name="Data[143]" type="text" value="<?php echo $Data[143]; ?>"></td>
	      <td><input class="span2"  name="Data[144]" type="text" value="<?php echo $Data[144]; ?>"></td>
	      <td><input class="span2"  name="Data[145]" type="text" value="<?php echo $Data[145]; ?>"></td>
	      <td><input class="span2"  name="Data[146]" type="text" value="<?php echo $Data[146]; ?>"></td>
	      <td><input class="span2"  name="Data[147]" type="text" value="<?php echo $Data[147]; ?>"></td>
	      ...
	      <td>- อื่น ๆ <input class="span2"  name="Data[151]" type="text" value="<?php echo $Data[151]; ?>"></td>
	      <td><input class="span2"  name="Data[152]" type="text" value="<?php echo $Data[152]; ?>"></td>
	      <td><input class="span2"  name="Data[153]" type="text" value="<?php echo $Data[153]; ?>"></td>
	      <td><input class="span2"  name="Data[154]" type="text" value="<?php echo $Data[154]; ?>"></td>
	      <td><input class="span2"  name="Data[155]" type="text" value="<?php echo $Data[155]; ?>"></td>
	      <td><input class="span2"  name="Data[156]" type="text" value="<?php echo $Data[156]; ?>"></td>
	    ...
	    <tr>
	      <td>- ระบุ <input class="span2"  name="Data[159]" type="text" value="<?php echo $Data[159]; ?>"></td>
	      <td><input class="span2"  name="Data[160]" type="text" value="<?php echo $Data[160]; ?>"></td>
	      <td><input class="span2"  name="Data[161]" type="text" value="<?php echo $Data[161]; ?>"></td>
	      <td><input class="span2"  name="Data[162]" type="text" value="<?php echo $Data[162]; ?>"></td>
	      <td><input class="span2"  name="Data[163]" type="text" value="<?php echo $Data[163]; ?>"></td>
	      <td><input class="span2"  name="Data[164]" type="text" value="<?php echo $Data[164]; ?>"></td>
	    ...
	    <tr>
	      <td>- ระบุ <input class="span2"  name="Data[167]" type="text" value="<?php echo $Data[167]; ?>"></td>
	      <td><input class="span2"  name="Data[168]" type="text" value="<?php echo $Data[168]; ?>"></td>
	      <td><input class="span2"  name="Data[169]" type="text" value="<?php echo $Data[169]; ?>"></td>
	      <td><input class="span2"  name="Data[170]" type="text" value="<?php echo $Data[170]; ?>"></td>
	      <td><input class="span2"  name="Data[171]" type="text" value="<?php echo $Data[171]; ?>"></td>
	      <td><input class="span2"  name="Data[172]" type="text" value="<?php echo $Data[172]; ?>"></td>
	    ...
	    <tr>
	      <td>- ระบุ <input class="span2"  name="Data[175]" type="text" value="<?php echo $Data[175]; ?>"></td>
	      <td><input class="span2"  name="Data[176]" type="text" value="<?php echo $Data[176]; ?>"></td>
	      <td><input class="span2"  name="Data[177]" type="text" value="<?php echo $Data[177]; ?>"></td>
	      <td><input class="span2"  name="Data[178]" type="text" value="<?php echo $Data[178]; ?>"></td>
	      <td><input class="span2"  name="Data[179]" type="text" value="<?php echo $Data[179]; ?>"></td>
	      <td><input class="span2"  name="Data[180]" type="text" value="<?php echo $Data[180]; ?>"></td>
	    ...
	    <tr>
	      <td>- จำนวนคนได้รับผลกระทบ <input class="span2"  name="Data[1202]" type="text" value="<?php echo $Data[1202]; ?>"></td>
	      <td><input class="span2"  name="Data[1203]" type="text" value="<?php echo $Data[1203]; ?>"></td>
	      <td><input class="span2"  name="Data[1204]" type="text" value="<?php echo $Data[1204]; ?>"></td>
	      <td><input class="span2"  name="Data[1205]" type="text" value="<?php echo $Data[1205]; ?>"></td>
	      <td><input class="span2"  name="Data[1206]" type="text" value="<?php echo $Data[1206]; ?>"></td>
	      <td><input class="span2"  name="Data[1207]" type="text" value="<?php echo $Data[1207]; ?>"></td>
	    ...
	    <tr>
	      <td>- จำนวนคนว่างงาน <input class="span2"  name="Data[1210]" type="text" value="<?php echo $Data[1210]; ?>"></td>
	      <td><input class="span2"  name="Data[1211]" type="text" value="<?php echo $Data[1211]; ?>"></td>
	      <td><input class="span2"  name="Data[1212]" type="text" value="<?php echo $Data[1212]; ?>"></td>
	      <td><input class="span2"  name="Data[1213]" type="text" value="<?php echo $Data[1213]; ?>"></td>
	      <td><input class="span2"  name="Data[1214]" type="text" value="<?php echo $Data[1214]; ?>"></td>
	      <td><input class="span2"  name="Data[1215]" type="text" value="<?php echo $Data[1215]; ?>"></td>
	    ...
	    <tr>
	      ...
	      <td><input class="span2"  name="Data[1218]" type="text" value="<?php echo $Data[1218]; ?>"></td>
	      <td><input class="span2"  name="Data[1219]" type="text" value="<?php echo $Data[1219]; ?>"></td>
	      <td><input class="span2"  name="Data[1220]" type="text" value="<?php echo $Data[1220]; ?>"></td>
	      <td><input class="span2"  name="Data[1221]" type="text" value="<?php echo $Data[1221]; ?>"></td>
	      <td><input class="span2"  name="Data[1222]" type="text" value="<?php echo $Data[1222]; ?>"></td>
	    ...
	    <tr>
	      ...
	      <td><input class="span2"  name="Data[1225]" type="text" value="<?php echo $Data[1225]; ?>"></td>
	      <td><input class="span2"  name="Data[1226]" type="text" value="<?php echo $Data[1226]; ?>"></td>
	      <td><input class="span2"  name="Data[1227]" type="text" value="<?php echo $Data[1227]; ?>"></td>
	      <td><input class="span2"  name="Data[1228]" type="text" value="<?php echo $Data[1228]; ?>"></td>
	      <td><input class="span2"  name="Data[1229]" type="text" value="<?php echo $Data[1229]; ?>"></td>
	    ...
	    <tr>
	      <td>- รถไถ</td>
	      <td><input class="span2"  name="Data[1116]" type="text" value="<?php echo $Data[1116]; ?>"></td>
	      <td><input class="span2"  name="Data[1117]" type="text" value="<?php echo $Data[1117]; ?>"></td>
	      <td><input class="span2"  name="Data[1118]" type="text" value="<?php echo $Data[1118]; ?>"></td>
	      <td><input class="span2"  name="Data[1119]" type="text" value="<?php echo $Data[1119]; ?>"></td>
	      <td><input class="span2"  name="Data[1120]" type="text" value="<?php echo $Data[1120]; ?>"></td>
	    ...
	    <tr>
	      <td>- รถกระบะ</td>
	      <td><input class="span2"  name="Data[1123]" type="text" value="<?php echo $Data[1123]; ?>"></td>
	      <td><input class="span2"  name="Data[1124]" type="text" value="<?php echo $Data[1124]; ?>"></td>
	      <td><input class="span2"  name="Data[1125]" type="text" value="<?php echo $Data[1125]; ?>"></td>
	      <td><input class="span2"  name="Data[1126]" type="text" value="<?php echo $Data[1126]; ?>"></td>
	      <td><input class="span2"  name="Data[1127]" type="text" value="<?php echo $Data[1127]; ?>"></td>
	    ...
	    <tr>
	      <td>- รถบรรทุก</td>
	      <td><input class="span2"  name="Data[1130]" type="text" value="<?php echo $Data[1130]; ?>"></td>
	      <td><input class="span2"  name="Data[1131]" type="text" value="<?php echo $Data[1131]; ?>"></td>
	      <td><input class="span2"  name="Data[1132]" type="text" value="<?php echo $Data[1132]; ?>"></td>
	      <td><input class="span2"  name="Data[1133]" type="text" value="<?php echo $Data[1133]; ?>"></td>
	      <td><input class="span2"  name="Data[1134]" type="text" value="<?php echo $Data[1134]; ?>"></td>
	    ...
	    <tr>
	      <td>- รถมอเตอร์ไซต์</td>
	      <td><input class="span2"  name="Data[1137]" type="text" value="<?php echo $Data[1137]; ?>"></td>
	      <td><input class="span2"  name="Data[1138]" type="text" value="<?php echo $Data[1138]; ?>"></td>
	      <td><input class="span2"  name="Data[1139]" type="text" value="<?php echo $Data[1139]; ?>"></td>
	      <td><input class="span2"  name="Data[1140]" type="text" value="<?php echo $Data[1140]; ?>"></td>
	      <td><input class="span2"  name="Data[1141]" type="text" value="<?php echo $Data[1141]; ?>"></td>
	    ...
	    <tr>
	      <td>- รถยนต์</td>
	      <td><input class="span2"  name="Data[1144]" type="text" value="<?php echo $Data[1145]; ?>"></td>
	      <td><input class="span2"  name="Data[1146]" type="text" value="<?php echo $Data[1147]; ?>"></td>
	      <td><input class="span2"  name="Data[1148]" type="text" value="<?php echo $Data[1148]; ?>"></td>
	      <td><input class="span2"  name="Data[1149]" type="text" value="<?php echo $Data[1149]; ?>"></td>
	      <td><input class="span2"  name="Data[1150]" type="text" value="<?php echo $Data[1150]; ?>"></td>
	    ...
	    <tr>
	      <td>- จักรเย็บผ้า</td>
	      <td><input class="span2"  name="Data[1153]" type="text" value="<?php echo $Data[1153]; ?>"></td>
	      <td><input class="span2"  name="Data[1154]" type="text" value="<?php echo $Data[1154]; ?>"></td>
	      <td><input class="span2"  name="Data[1155]" type="text" value="<?php echo $Data[1155]; ?>"></td>
	      <td><input class="span2"  name="Data[1156]" type="text" value="<?php echo $Data[1156]; ?>"></td>
	      <td><input class="span2"  name="Data[1157]" type="text" value="<?php echo $Data[1157]; ?>"></td>
	    ...
	    <tr>
	      ...
	      <td><input class="span2"  name="Data[1160]" type="text" value="<?php echo $Data[1160]; ?>"></td>
	      <td><input class="span2"  name="Data[1161]" type="text" value="<?php echo $Data[1161]; ?>"></td>
	      <td><input class="span2"  name="Data[1162]" type="text" value="<?php echo $Data[1162]; ?>"></td>
	      <td><input class="span2"  name="Data[1163]" type="text" value="<?php echo $Data[1163]; ?>"></td>
	      <td><input class="span2"  name="Data[1164]" type="text" value="<?php echo $Data[1164]; ?>"></td>
	    ...
	    <tr>
	      <td>- อื่นๆ <input class="span2"  name="Data[1167]" type="text" value="<?php echo $Data[1167]; ?>"></td>
	      <td><input class="span2"  name="Data[1168]" type="text" value="<?php echo $Data[1168]; ?>"></td>
	      <td><input class="span2"  name="Data[1169]" type="text" value="<?php echo $Data[1169]; ?>"></td>
	      <td><input class="span2"  name="Data[1170]" type="text" value="<?php echo $Data[1170]; ?>"></td>
	      <td><input class="span2"  name="Data[1171]" type="text" value="<?php echo $Data[1171]; ?>"></td>
	      <td><input class="span2"  name="Data[1172]" type="text" value="<?php echo $Data[1172]; ?>"></td>
	    ...
	    <tr>
	      <td>- อื่น ๆ <input class="span2"  name="Data[1108]" type="text" value="<?php echo $Data[623]; ?>"></td>
